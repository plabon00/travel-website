...
export default function Hero() {
  ...
  return (
    // Added min-h-screen to ensure full height and increased top padding (pt-40 lg:pt-48) 
    // to account for the new absolute floating navbar.
    <section 
      className="relative bg-[#0f172a] text-white pt-40 lg:pt-48 pb-24 px-6 md:px-12 bg-cover bg-center min-h-screen flex items-center" 
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-lg text-gray-200 mb-8 mt-4 max-w-md drop-shadow-md">
            Seamless corporate and leisure bookings from your trusted USA partner.
          </p>

          {/* Badges */}
          <div className="grid grid-cols-2 gap-4 mb-8 text-xs font-semibold text-gray-200">
          ...
          <div className="flex flex-wrap gap-4">
            <button 
              ...
              className="bg-[#ff6b00] hover:bg-[#e66000] text-white px-6 py-3 rounded-full font-bold flex items-center space-x-2 transition shadow-lg shadow-[#ff6b00]/30"
            >
              <Plane size={18} /> 
              <span>EXPLORE OPTIONS</span>
            </button>
            <button className="bg-black/40 backdrop-blur-sm border border-white/50 hover:bg-white hover:text-black text-white px-6 py-3 rounded-full font-bold flex items-center space-x-2 transition">
        ...
        <div className="bg-[#111827]/90 backdrop-blur-xl border border-gray-700/50 rounded-2xl p-6 shadow-[0_8px_32px_rgba(0,0,0,0.5)] min-h-[500px] flex flex-col relative z-20">
